...
routes.post('/add', (req, res) => {
  Controller.add(req.body.firstname, req.body.lastname, req.body.email, req.body.SubjectId, (err, data) => {
    if (!err) {
...
routes.post('/edit/:id', (req, res) => {
  Controller.edit(req.params.id, req.body.firstname, req.body.lastname, req.body.email, req.body.SubjectId, (err, data) => {
    if (!err) {
      res.redirect('/teachers');
    } else {
